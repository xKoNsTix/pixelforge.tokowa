		...
		public function get_dynamic_stylesheet_info( $what = 'path' )
		{
			...
			switch( $what )
			{
				case 'filename':
					...
					break;
				case 'path':
					$stylesheet_path = $wp_upload_dir['basedir'] . $avia_config['dynamic_files_upload_folder'];
				...
				case 'url':
				default:
					$stylesheet_url = $wp_upload_dir['baseurl'] . $avia_config['dynamic_files_upload_folder'];
